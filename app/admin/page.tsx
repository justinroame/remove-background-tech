...
const PASSWORD = "Poop4lifeyo!"; // Change this to whatever you want
...
export default async function AdminDashboard({
  ...
  // Get all users with credits + pro status
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-black text-white p-8 md:p-16 font-mono">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-2xl mb-12 text-gray-300">
          {allUsers.length} total users • Live view
        </p>
        ...
        <div className="mt-16 bg-gray-900/50 rounded-3xl p-8 border border-gray-800">
          ...
          <form action="/api/admin/add-credits" method="POST" className="flex gap-4 flex-wrap">
            <input
              name="email"
              type="email"

      ...
      <main className="mx-auto max-w-4xl px-6 py-20">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="space-y-4 mt-16">
            ...
            <div className="flex gap-3 justify-center">
              <img src="/woman-in-pink-dress.jpg" alt="Sample 1" className="size-20 rounded-xl object-cover" />
              <img src="/iphone-product.jpg" alt="Sample 2" className="size-20 rounded-xl object-cover" />
              <img src="/silver-sports-car.jpg" alt="Sample 3" className="size-20 rounded-xl object-cover" />
...
}" alt="Sample 2" className="size-20 rounded-xl object-cover" />
